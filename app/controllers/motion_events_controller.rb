class MotionEventsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @motion_event.save
        ...
        format.json { render :show, status: :created, location: @motion_event }
      else
  ...
  def update
    respond_to do |format|
      if @motion_event.update(motion_event_params)
        ...
        format.json { render :show, status: :ok, location: @motion_event }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to motion_events_url, notice: 'Motion event was successfully destroyed.' }
  ...
  private
    ...
    def motion_event_params
      params.require(:motion_event).permit(:event)
    end
end
